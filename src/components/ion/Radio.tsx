...
// Figma Link: https://www.figma.com/design/GzGS1XBtO8fnXGsjKDPiIf?node-id=2:8954
// ion/Radio: Generated with Ion on 10/10/2024, 7:45:39 AM
...
>(
  (
    { className, label, required, description, helper, error, ...props },
    ref
  ) => {
